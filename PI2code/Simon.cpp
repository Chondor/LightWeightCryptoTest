...
void Simon::SimonEncryptBlockALL(u64 PL,u64 PR,u64 &CL, u64 &CR, u64* key,int nn,int keysize)
{
	u64 k[72]={0};
	/*
	-------------------------- definitions --------------------------
...
void Simon::SimonDecryptBlock64128(u32 CL,u32 CR,u32 &PL, u32 &PR, u32* key,int nn,int keysize,int rounds){
	u32 k[72]={0};
	int mm=keysize/nn;
	int Cj=0,T=0;
...
void Simon::SimonEncryptBlock64128(u32 PL,u32 PR,u32 &CL, u32 &CR, u32* key,int nn,int keysize,int rounds)
{
...
void Simon::Run(unsigned int plaintext[2],const char *keystr, int plaintextlength)
{
	u32 PL,PR,CL,CR;
	//u32 key[4]={0};
	...
	for( int i=0;i<plaintextlength;i++)
		SimonEncryptBlock64128(PL,PR,CL,CR,(u32*)keystr,32,128,44);
}
