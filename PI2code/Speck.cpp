...
void Speck::SpeckEncryptBlock64128(u32 PL,u32 PR,u32 &CL, u32 &CR, u32* key,int nn,int keysize,int rounds){
...
void Speck::SpeckEncryptBlock(u64 PL,u64 PR,u64 &CL, u64 &CR, u64* key,int nn,int keysize){
	// speck (64,128) version only
	// nn = 32; keysize = 128; mm = 4;
	int mm=keysize/nn;
	//int Cj=0;
...
void Speck::Run(unsigned int plaintext[2],const char *keystr, int plaintextlength)
{
	u32 PL,PR,CL,CR;
	//u32 key[4]={0};
	...
	for( int i=0;i<plaintextlength;i++)
		SpeckEncryptBlock64128(PL,PR,CL,CR,(u32*)keystr,32,128,27);
}
